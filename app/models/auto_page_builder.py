...
from app.database.connection import execute_query, execute_insert, start_transaction, commit_transaction, rollback_transaction
...
def store_page(auto_page_data):
    ...
    try:
        ...
        page_id_query = "SELECT LAST_INSERT_ID() as id"
        page_id_result = execute_query(page_id_query)
        page_id = page_id_result[0]['id']
